...
class UserControllerTest {
  ...
  void testGetCurrentUser() {
    when(userService.getCurrentUser(any(Jwt.class))).thenReturn(testUser);

    UserProfile result = controller.getCurrentUser(jwt);
  ...
  void testUpdateCurrentUser() throws Exception {
    ...
    UserProfile result = controller.updateCurrentUser(jwt, requestBody);
